                ...
                <el-aside class="left-container" :style="{width:collpaseWidth}">
                    ...
                    >
                        ...
                        <el-submenu class="text left-action"  index="1">
                            ...
                            <el-menu-item class="text left-action" index="/InventoryInvestigation" :route="{name:'InventoryInvestigation'}">存量排查
                            </el-menu-item>
                            ...
                            <el-menu-item class="text left-action" index="/ResourceUtilization" :route="{name:'ResourceUtilization'}">资源利用</el-menu-item>
                        </el-submenu>
                        ...
                        <el-submenu class="text left-action" index="2">
                            ...
                            <el-menu-item class="text left-action" index="/UrbanStatistics" :route="{name:'UrbanStatistics'}">城市统计</el-menu-item>
                            <el-menu-item class="text left-action" index="/leixingtongji" :route="{name:'leixingtongji'}">类型统计</el-menu-item>
                        </el-submenu>
                        ...
                        <el-submenu class="text left-action" index="3">
                            ...
                            <el-menu-item class="text left-action" index="/ThermodynamicDiagram" :route="{name:'ThermodynamicDiagram'}">热力图分析</el-menu-item>
                        ...
                        <el-submenu class="text left-action" index="4">
                            ...
                            <el-menu-item class="text left-action" index="/Inclinometer" :route="{name:'Inclinometer'}">测斜仪监测</el-menu-item>
                        ...
                        <el-menu-item class="text left-action" onclick="javascript:window.open('http://localhost:8081/cesiumMap/map.html')">
                            <i style="color:#fff" class="fa fa-globe"></i>
                            <span >三维系统</span>
                        </el-menu-item>
