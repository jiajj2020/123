        ...
        <el-row style="padding-top: 10px">
          <el-col :xs="24" :sm="24" :md="11" :lg="5" :xl="5">
            <el-form-item class="main-text" label="类型统计 :" label-width="110px">
              <el-cascader v-model="values" :options="options" @change="handleChange">
                <!-- <el-cascader v-model="values" :options="options" @change="getChartData"> -->
              </el-cascader>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="11" :lg="5" :xl="5">
            <el-form-item class="main-text" label="月份 :" label-width="110px">
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="5" :xl="5" style="padding-top: 4px;text-align: right">
            <el-button type="primary" size="small" @click="getChartData()" :loading="staLoading">查询
            </el-button>
          </el-col>
          <!-- <el-col :xs="24" :sm="24" :md="13" :lg="7" :xl="7">
                        <el-form-item style="text-align: center;margin-bottom: 10px;">
                            <el-button  size="medium" @click="getChartData()" :loading="staLoading">查询</el-button>
                            <el-button type="primary" size="medium" :loading="listLoading">重置</el-button>
                        </el-form-item>
                    </el-col> -->
        </el-row>
      </el-form>
      <el-col :xs="12" :sm="12" :md="11" :lg="11">
        <div id="main" style="height:700px" ></div>
      </el-col>
      <el-col  :xs="24" :sm="11" :md="11" :lg="11">
        <div id="main3" style="height: 700px;" ></div>
      </el-col>
      <!-- <el-col :offset="12" :xs="12" :sm="11" :md="11" >
        <div id="main4" style="height: 700px;" v-if="values[0]==='cunliangpaicha'"></div>
      </el-col> -->
    ...
    methods: {
      ...
      drawPie2(id) {
        ...
        this.charts.setOption({
          ...
          title: {
            text: '2019年11月-2020年5月深圳市建筑垃圾排查情况',
            textStyle: {
              fontWeight: 'normal',
              fontSize: 18, //字体大小
              color: '#fff'
          ...
          series: [{
              ...
              stack: '总量',
              areaStyle: {},
              data: [100, 112, 81, 114, 70, 210, 190]
            },
            {
              name: '拆除垃圾',
              type: 'line',
